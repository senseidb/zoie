...
public class Pair<R extends IndexReader, D> implements Zoie<R, D> {
  ...
  public Pair(File zoieOneRoot, DIRECTORY_MODE dirMode, IndexCopier indexCopier,
    ...
    // Initialize zoieOne:
    if (_zoieOneRoot == null) throw new IllegalArgumentException("zoieOneRoot cannot be null.");
  ...
  public void start() {
    ...
    if (zoieOne != null) zoieOne.start();

    if (_zoieTwo != null) _zoieTwo.start();
  }

  public void shutdown() {
    _running = false;
    Zoie zoieOne = _zoieOne;
    if (zoieOne != null) zoieOne.shutdown();

    if (_zoieTwo != null) _zoieTwo.shutdown();
  }
  ...
  public void syncWithVersion(long timeInMillis, String version) throws ZoieException {
    ...
    if (_zoieTwo != null) _zoieTwo.syncWithVersion(timeInMillis, version);
  }
  ...
  public void flushEvents(long timeout) throws ZoieException {
    ...
    if (_zoieTwo != null) _zoieTwo.flushEvents(timeout);
  }

  public void consume(Collection<DataEvent<D>> data) throws ZoieException {
    if (_zoieTwo != null) _zoieTwo.consume(data);
  }

  public String getVersion() {
    String v1 = null, v2 = null;
    Zoie zoieOne = _zoieOne;
    if (zoieOne != null) v1 = zoieOne.getVersion();

    if (_zoieTwo != null) v2 = _zoieTwo.getVersion();
  ...
  public String getCurrentReaderVersion() {
    String v1 = null, v2 = null;
    Zoie zoieOne = _zoieOne;
    if (zoieOne != null) v1 = zoieOne.getCurrentReaderVersion();

    if (_zoieTwo != null) v2 = _zoieTwo.getCurrentReaderVersion();
  ...
  public List<ZoieIndexReader<R>> getIndexReaders() throws IOException {
    ...
    if (_zoieTwo != null) readers.addAll(_zoieTwo.getIndexReaders());
